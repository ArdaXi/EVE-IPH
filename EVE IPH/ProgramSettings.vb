...
Public Class ProgramSettings
    ...
    Dim DefaultMTRuns As Integer = 10
    Dim DefaultMTProductionLines As Integer = 11
    Dim DefaultMTLaboratoryLines As Integer = 12
    Dim DefaultMTTotalInventionRECost As Integer = 13
    Dim DefaultMTTotalCopyCost As Integer = 14
    Dim DefaultMTTotalManufacturingCost As Integer = 15
    Dim DefaultMTTaxes As Integer = 16
    Dim DefaultMTBrokerFees As Integer = 17
    Dim DefaultMTBPProductionTime As Integer = 18
    Dim DefaultMTTotalProductionTime As Integer = 19
    Dim DefaultMTItemMarketPrice As Integer = 20
    Dim DefaultMTProfit As Integer = 21
    Dim DefaultMTProfitPercentage As Integer = 22
    Dim DefaultMTIskperHour As Integer = 23
    Dim DefaultMTSVR As Integer = 24
    Dim DefaultMTTotalCost As Integer = 25
    Dim DefaultMTBaseJobCost As Integer = 26
    Dim DefaultMTManufacturingJobFee As Integer = 27
    Dim DefaultMTManufacturingFacilityName As Integer = 28
    Dim DefaultMTManufacturingFacilitySystem As Integer = 29
    Dim DefaultMTManufacturingFacilitySystemIndex As Integer = 30
    Dim DefaultMTManufacturingFacilityTax As Integer = 31
    Dim DefaultMTManufacturingFacilityRegion As Integer = 32
    Dim DefaultMTManufacturingFacilityMEBonus As Integer = 33
    Dim DefaultMTManufacturingFacilityTEBonus As Integer = 34
    Dim DefaultMTManufacturingFacilityUsage As Integer = 35
    Dim DefaultMTComponentFacilityName As Integer = 36
    Dim DefaultMTComponentFacilitySystem As Integer = 37
    Dim DefaultMTComponentFacilitySystemIndex As Integer = 38
    Dim DefaultMTComponentFacilityTax As Integer = 39
    Dim DefaultMTComponentFacilityRegion As Integer = 40
    Dim DefaultMTComponentFacilityMEBonus As Integer = 41
    Dim DefaultMTComponentFacilityTEBonus As Integer = 42
    Dim DefaultMTComponentFacilityUsage As Integer = 43
    Dim DefaultMTCopyingFacilityName As Integer = 44
    Dim DefaultMTCopyingFacilitySystem As Integer = 45
    Dim DefaultMTCopyingFacilitySystemIndex As Integer = 46
    Dim DefaultMTCopyingFacilityTax As Integer = 47
    Dim DefaultMTCopyingFacilityRegion As Integer = 48
    Dim DefaultMTCopyingFacilityMEBonus As Integer = 49
    Dim DefaultMTCopyingFacilityTEBonus As Integer = 50
    Dim DefaultMTCopyingFacilityUsage As Integer = 51
    Dim DefaultMTInventionREFacilityName As Integer = 52
    Dim DefaultMTInventionREFacilitySystem As Integer = 53
    Dim DefaultMTInventionREFacilitySystemIndex As Integer = 54
    Dim DefaultMTInventionREFacilityTax As Integer = 55
    Dim DefaultMTInventionREFacilityRegion As Integer = 56
    Dim DefaultMTInventionREFacilityMEBonus As Integer = 57
    Dim DefaultMTInventionREFacilityTEBonus As Integer = 58
    Dim DefaultMTInventionREFacilityUsage As Integer = 59
    Dim DefaultMTManufacturingTeamName As Integer = 60
    Dim DefaultMTManufacturingTeamBonuses As Integer = 61
    Dim DefaultMTManufacturingTeamUsage As Integer = 62
    Dim DefaultMTManufacturingTeamCostModifier As Integer = 63
    Dim DefaultMTComponentTeamName As Integer = 64
    Dim DefaultMTComponentTeamBonuses As Integer = 65
    Dim DefaultMTComponentTeamUsage As Integer = 66
    Dim DefaultMTComponentTeamCostModifier As Integer = 67
    Dim DefaultMTCopyingTeamName As Integer = 68
    Dim DefaultMTCopyingTeamBonuses As Integer = 69
    Dim DefaultMTCopyingTeamUsage As Integer = 70
    Dim DefaultMTCopyingTeamCostModifier As Integer = 71
    Dim DefaultMTInventionRETeamName As Integer = 72
    Dim DefaultMTInventionRETeamBonuses As Integer = 73
    Dim DefaultMTInventionRETeamUsage As Integer = 74
    Dim DefaultMTInventionRETeamCostModifier As Integer = 75
